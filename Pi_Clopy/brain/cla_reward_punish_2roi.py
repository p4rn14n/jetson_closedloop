...
# recorded_audio = []
# class RecordingSineSource(SineSource):
#     def _get_sine_block(self):
#         print("[RECORD DEBUG] _get_sine_block() called")
#         block = super()._get_sine_block()
#         recorded_audio.append(block.copy())
#         return block
#     def read (self, num_bytes=None):
#         print("[RECORD DEBUG] read() called")
...
#                                                      tables.Atom.from_dtype(totRewards), (0,))
    ...
    #sinsource = RecordingSineSource(austream, 1000)
    sinsource.stop()
    #############
        ...
        if runTrial:
            ...
            if rest and time.time() - restTimer < rest_duration:
                ...
                ##### NEW NEW FINISH
                    ...
                    #sinsource = RecordingSineSource(austream, freq)
                    sinsource.start()
